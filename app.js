...
function computeCurrentSessionSummary() {
  ...
  const assessmentReadinessFactor = Number((completionFactor * disciplineFactor * coverageFactor).toFixed(3));
